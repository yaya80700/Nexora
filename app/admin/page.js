...
const empty={type:"formation",slug:"",title:"",name:"",full_name:"",category:"",level:"",icon:"✨",description:"",bullets:[],price:"",price_label:"",status:"",accent:"",url:"",active:true,sort_order:0};
...
export default function Admin(){
 ...
 return <main className="adminPage"><header className="adminTop"><div><span className="sectionTag">NEXORA ADMIN</span><h1>Panneau de <span>contrôle.</span></h1><p>Gérez le catalogue public sans modifier le code.</p></div><div className="adminActions"><Link href="/" className="secondary">Voir le site</Link><button className="secondary" onClick={logout}><LogOut size={15}/> Déconnexion</button></div></header>
