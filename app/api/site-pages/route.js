...
export async function GET() {
  try {
    ...
    const fixedKeys = ["home","formations","abonnements","services","sites","contact"];
    ...
    const fixedLabels = {home:"Accueil",formations:"Formations",abonnements:"Abonnements",services:"Nos services",sites:"Nos sites",contact:"Nous contacter"};
    const fixedRoutes = {home:"/",formations:"/formations",abonnements:"/abonnements",services:"/services",sites:"/sites",contact:"/contact"};
