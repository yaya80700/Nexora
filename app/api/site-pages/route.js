...
export async function GET() {
  try {
    ...
    const fixedKeys = ["home","formations","abonnements","projets","services","sites","contact"];
    ...
    const fixedLabels = {home:"Accueil",formations:"Formations",abonnements:"Abonnements",services:"Nos services",sites:"Nos sites",projets:"Nos projets",contact:"Nous contacter"};
    const fixedRoutes = {home:"/",formations:"/formations",abonnements:"/abonnements",services:"/services",sites:"/sites",projets:"/projets",contact:"/contact"};
