...
const reserved = new Set(["connexion","inscription","compte","profil","contact","formations","abonnements","a-propos","services","sites","projets","demandes","notifications","parametres","academy","mot-de-passe-oublie","reinitialiser-mot-de-passe","admin","auth","api"]);
