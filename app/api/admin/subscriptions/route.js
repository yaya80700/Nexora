...
export async function POST(request) {
  ...
  if ((count || 0) >= 5) return NextResponse.json({ error: "Nexora est limité à 5 abonnements. Supprimez ou modifiez une formule existante avant d'en créer une nouvelle." }, { status: 400 });
