...
import { ArrowLeft, ArrowRight, CheckCircle2, LoaderCircle, UserRound, Sparkles } from "lucide-react";
...
export default function Profil() {
  ...
  return <main><Header/><section className="authPage"><div className="authCard">
    ...
    <section className={`profileSubscriptionCard ${subscriptionClass}`}>
      ...
      <div className="profileSubscriptionText">
        ...
        {subscription ? <><strong>{subscription.subscription_name}</strong><small>Votre formule est actuellement active sur votre compte.</small></> : <><strong>Aucun abonnement</strong><small>Vous n’avez pas encore d’abonnement attribué.</small></>}
      </div>
