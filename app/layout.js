...
export const metadata={
 ...
 keywords:["Nexora","développement","FiveM","GMod","formations","site web","optimisation PC","services numériques","réalisations","projets numériques"],
 authors:[{name:"Nexora"}],
 icons:{icon:"/nexora-logo.png",apple:"/nexora-logo.png"},
 metadataBase:new URL("https://nexoraplateforme.vercel.app")
};
