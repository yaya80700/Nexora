...
import { BookOpen, MessageSquare, UserRound, ArrowUpRight, LogOut } from "lucide-react";
...
export default async function Compte() {
  ...
  return <main><Header/><section className="subPage"><div className="subHero">
    ...
    <div className="dashboardGrid">
      ...
      <article className="dashCard"><div className="dashIcon"><UserRound/></div><span>PROFIL</span><h2>Mes informations</h2><p>Votre identité de compte est gérée par le système Nexora.</p><span className="coming">PROFIL</span></article>
    </div>
