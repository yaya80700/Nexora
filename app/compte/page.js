...
import { BookOpen, MessageSquare, UserRound, ArrowUpRight } from "lucide-react";
import Header from "../ui/Header";
import Footer from "../ui/Footer";
export const metadata={title:"Mon espace"};
export default function Compte(){return <main><Header/><section className="subPage"><div className="subHero"><span className="sectionTag">ESPACE CLIENT</span><h1>Votre espace<br/><span>Nexora.</span></h1><p className="lead">Retrouvez vos formations, vos demandes et vos échanges avec Nexora au même endroit.</p>
