    ...
    <section className="subPage accountPage">
      <div className="subHero accountHero">
        ...
        <div className="accountStatsGrid">
          ...
          <Stat icon={<Sparkles />} value={accountSubscription ? "Actif" : "—"} label="Abonnement" hint={accountSubscription ? `Attribué le ${formatDate(accountSubscription.assigned_at)}` : "Aucune formule active"} />
