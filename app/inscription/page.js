...
export default function Inscription(){
 ...
 return <main><Header/><section className="authPage"><div className="authCard">
  ...
  <h1>Bienvenue sur <span>Nexora.</span></h1><p className="lead">Créez votre espace pour retrouver vos formations, demandes et futures commandes au même endroit.</p>
