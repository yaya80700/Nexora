...
export async function middleware(request) {
  ...
  const isProtected = request.nextUrl.pathname.startsWith("/compte") || request.nextUrl.pathname.startsWith("/profil") || request.nextUrl.pathname.startsWith("/demandes") || request.nextUrl.pathname.startsWith("/parametres") || request.nextUrl.pathname.startsWith("/notifications") || request.nextUrl.pathname.startsWith("/academy");
