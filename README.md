...
## V1.6.9 — Compatibilité mobile
Le design desktop original de V1.6.9 est conservé. Une couche CSS responsive dédiée adapte le panneau de contrôle, le catalogue, l'éditeur, les utilisateurs/staff et les demandes aux tablettes et mobiles, sans créer de seconde version du site.
