...
- `/admin` — Panneau de contrôle unifié et éditeur du site
...
L’éditeur du site est désormais intégré directement dans `/admin`. Le panneau centralise Catalogue, Éditeur du site, Utilisateurs & Staff et Demandes clients. L’ancien accès `/admin/editor` n’est plus utilisé : l’éditeur est intégré directement dans `/admin`.


## V1.6.6 — Panneau admin unifié
...
## V1.6.6 — Panneau unique
- Le routeur `/admin/editor` a été supprimé et le lien d’accès renvoie désormais vers `/admin`.
