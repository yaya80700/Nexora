...
## V1.7.0 — Mobile parity
- Responsive finalisation du panneau de contrôle, du catalogue, de l’éditeur, des utilisateurs et des demandes.
- Navigation admin horizontale sur mobile.
- Actions Voir le site / Aperçu / Enregistrer accessibles sur téléphone.
- Formulaires, blocs, cartes et tableaux adaptés aux écrans étroits sans débordement horizontal.
