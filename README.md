# Nexora V1.1.1 — Administration

Nexora est une plateforme Next.js 15 + Supabase. V1.1.1 ajoute un véritable espace d'administration privé pour gérer les formations, services et sites depuis le navigateur.
